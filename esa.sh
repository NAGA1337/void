...
# FORMATING
mkfs.vfat -F 32 -n EFI ${DEVNAME}p1
mkswap -L swp0 ${DEVNAME}p2
mkfs.$FSYS -L voidlinux ${DEVNAME}p3
mkfs.$FSYS -L home ${DEVNAME}p4
...
# When UEFI
mkdir /mnt/boot/efi && mount ${DEVNAME}p1 /mnt/boot/efi
